...
public class Utility {
    ...
    public static boolean isMetric(Context context){
        ...
        return prefs.getString(context.getString(R.string.pref_unit_key),context.getString(R.string.pref_unit_metric)).equals(
    ...
    static String formatDate(long millisec){
    ...
    public static String getFormattedMonthDay(Context context,long dateInMillis){
        ...
        SimpleDateFormat dayMonthformat=new SimpleDateFormat("MMMM dd");
        String MonthDayString=dayMonthformat.format(dateInMillis);
